...
LISTS & OBJECTS
    ...
    let o = {name: "crt", n: 1};
    o.name;  o.name = "x";
    o["name"];                  NOT supported -- use o.name for objects
...
GRAPHICS (pygame mode) -- see `crt demo graphics` for more detail
...
def cmd_demo(args):
    if getattr(args, "topic", None) == "graphics":
...
def main(argv=None):
    ...
    p_demo.add_argument("topic", nargs="?", choices=["graphics"],
                         help="Optional: 'graphics' for the pygame cheat sheet")
